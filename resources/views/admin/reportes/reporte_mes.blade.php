...
@section('content_header')
 ...
 <a class="btn btn-success btn-sm float-right" href="{{route('admin.reportes.pdf_mes')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"  fill="currentColor" class="bi bi-filetype-pdf" viewBox="0 0 16 16">
...
<body>
 <div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
         <div >
                    <a class="btn btn-sm" href="{{ route('admin.reportes.meses') }}"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
