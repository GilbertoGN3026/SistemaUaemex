            ...
            <tbody>
                ...
                <tr>
                    ...
                    @can('admin.insumos.edit')
                        <a class="btn btn-success btn-sm" href="{{route('admin.insumos.edit', $insumo)}}">
                    ...
                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <td width="3px">
                        ...
                        <a class="btn btn-warning btn-sm" href="{{route('admin.insumos.show', $insumo)}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
